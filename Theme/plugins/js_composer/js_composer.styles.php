...
if ( !function_exists( 'prolingua_vc_get_css' ) ) {
	add_filter( 'prolingua_filter_get_css', 'prolingua_vc_get_css', 10, 4 );
	function prolingua_vc_get_css($css, $colors, $fonts, $scheme='') {
...
.vc_progress_bar.vc_progress_bar_narrow .vc_single_bar {
	background-color: {$colors['extra_bg_color_01']};
}
...
/*  Toggle Rounded Faq */
.vc_toggle.vc_toggle_rounded.vc_toggle_color_default {
    background-color: {$colors['bg_color']};
}
