...
if (!function_exists('prolingua_trx_addons_get_css')) {
	add_filter('prolingua_filter_get_css', 'prolingua_trx_addons_get_css', 10, 4);
	function prolingua_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.trx_addons_tabs .trx_addons_tabs_content .post_item .post_categories .post_info_item  .post_counters_item::before {
    color: {$colors['alter_link']};
}
.trx_addons_tabs .trx_addons_tabs_content .post_item .post_categories .post_info_item  .post_counters_item:hover::before {
...
.sc_price_item .sc_price_item_plan_wrapper {
    background-color: {$colors['extra_bg_color']};
    border-color: {$colors['extra_bd_color']};
}
...
.sc_price_default .sc_price_item_info .sc_price_item_link.sc_button.with_text_link {
    background-color: {$colors['extra_link']};
    color: {$colors['inverse_link']};
}
.sc_price_default .sc_price_item_info .sc_price_item_link.sc_button.with_text_link:hover {
    background-color: {$colors['text_hover']};
    color: {$colors['inverse_link']};
}
.sc_price_default .sc_price_item_info .sc_price_item_link.sc_button.without_text_link {
    background-color: transparent;
}
.sc_price_default .sc_price_item_info .sc_price_item_link.sc_button.without_text_link:hover {
    background-color: transparent;
}
.sc_price_default .sc_price_item_info .sc_price_item_link.sc_button.without_text_link:after {
    color: {$colors['alter_bd_color']};
}
.sc_price_default .sc_price_item_info .sc_price_item_link.sc_button.without_text_link:hover:after {
    color: {$colors['text_dark']};
}
...
.sc_services_default .trx_addons_columns_wrap > [class*="trx_addons_column-"]:nth-child(2n+1) .sc_services_item_header {
	background-color: {$colors['text_link']};
}
.sc_services_default .trx_addons_columns_wrap > [class*="trx_addons_column-"]:nth-child(2n) .sc_services_item_header {
	background-color: {$colors['alter_link3']};
}
.sc_services_default .sc_services_item_header .sc_services_item_title {
    color: {$colors['inverse_link']};
}
.sc_services_item_button.sc_item_button .button_icon:before {
	color: {$colors['alter_bd_color']};
}
.sc_services_item_button.sc_item_button .button_icon:hover::before {
    color: {$colors['alter_hover']};
}
...
.sc_skills.sc_skills_counter .sc_skills_legend_title,
.sc_skills.sc_skills_counter .sc_skills_legend_value {
	color:{$colors['extra_link2']};
}
...
.custom_section.custom_section_left .custom_section_content a:hover {
    color:{$colors['text_link']};
}
.custom_section.custom_section_right .socials_wrap .social_item .social_icon:hover {
     color:{$colors['text_link']};
}
/* Socials */
.socials_wrap .social_item .social_icon {
...
.custom_section.custom_section_right .socials_wrap .social_item .social_icon {
    	background-color: transparent;
    	color:{$colors['extra_link3']};
}
.socials_wrap .social_item .social_icon,
...
.sc_team .sc_team_item_thumb .sc_team_item_socials .social_item + .social_item:before {
...
.single-cpt_team .team_member_page .team_member_socials .social_item .social_icon:hover {
    color: {$colors['alter_bg_color']};
	background-color: {$colors['extra_link']};
}
