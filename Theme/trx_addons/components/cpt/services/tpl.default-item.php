...
?>>
	...
	<div class="sc_services_item_info">
		<?php if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) { ?>
			...
			<div class="sc_services_item_button sc_item_button"><a href="<?php echo esc_url($link); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'button_icon', 'sc_services', $args)); ?>"></a></div>
		<?php } ?>
	</div>
</div>
<?php
