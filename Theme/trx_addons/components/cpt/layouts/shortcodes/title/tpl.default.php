	...
	if ( $need_content || $need_image )  {
		...
		?><div<?php if (!empty($args['id'])) echo ' id="'.esc_attr($args['id']).'"'; ?> class="sc_layouts_title<?php
			...
			if ( $need_content )  {
                ...
                if (!empty($args['breadcrumbs']) && !empty($args['meta'] ))  {
                    ?><div class="sc_layouts_title_breadcrumbs top"><?php
						...
						?><div class="sc_layouts_title_title"><?php
							...
							<h1<?php trx_addons_seo_snippets('headline'); ?> class="sc_layouts_title_caption<?php echo esc_attr($trx_addons_blog_title_class); ?>"><?php
								...
								if (!empty($trx_addons_top_icon)) {
									...
									?><img src="<?php echo esc_url($trx_addons_top_icon); ?>" alt="'.esc_attr__('img', 'prolingua').'" <?php if (!empty($trx_addons_attr[3])) trx_addons_show_layout($trx_addons_attr[3]);?>><?php
								}
