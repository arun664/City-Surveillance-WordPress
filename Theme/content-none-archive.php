<article <?php post_class( 'post_item_single post_item_404 post_item_none_archive' ); ?>>
	<div class="post_content">
		...
		<div class="page_info">
			<h3 class="page_subtitle"><?php esc_html_e("We're sorry, but your query did not match", 'prolingua'); ?></h3>
			...
			?></p>
			<?php do_action('prolingua_action_search', 'normal', 'page_search', false); ?>
		</div>
	</div>
</article>
